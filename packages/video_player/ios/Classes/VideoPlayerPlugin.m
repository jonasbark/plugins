                ...
                void (^trackCompletionHandler)(void) = ^{
                    ...
                    if ([videoTrack statusOfValueForKey:@"preferredTransform" error:nil] ==
                        ...
                        dispatch_async(dispatch_get_main_queue(), ^{
                            NSLog(@"orient: %i", [self videoOrientation]);
...
{
    NSArray *videoTracks = [self.player.currentItem.asset tracksWithMediaType:AVMediaTypeVideo];
    ...
    switch ((int)videoAngleInDegree) {
        ...
        case 90:
            ...
            //[self.player setAffineTransform:CGAffineTransformMakeRotation(degreeToRadian(degree))];
            break;
        case 180:
...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    if ([@"init" isEqualToString:call.method]) {
        ...
        if ([@"dispose" isEqualToString:call.method]) {
            ...
            [player pause];
            result(nil);
        } else if ([@"orientation" isEqualToString:call.method]) {
            result([NSNumber numberWithInt:[player videoOrientation]]);
        } else {
